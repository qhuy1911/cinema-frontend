...
function Ticket() {
  ...
  useEffect(() => {
    TicketDataService.getTicket(1).then((ticket) => {
      setTicket(ticket.data);
      setSchedule(ticket.data.schedule);
      setMovie(ticket.data.schedule.movie);
      setRoom(ticket.data.schedule.room);
    });
  }, []);
  return (
    <div class="containt-ticket">
      <main class="ticket-system">
        ...
        <div class="receipts-wrapper">
          <div class="receipts">
            <div class="receipt">
              <h1 class="title">Vé xem phim</h1>
              <div class="poster">
                <img
                  src="https://cdn.tgdd.vn/Files/2020/09/03/1286576/top-25-tap-phim-hoat-hinh-doremon-dai-hay-nhat-cho-be-202009031354481060.jpg"
                  alt="Phim: Doraemon"
                />
              </div>
              <h2>{movie.name}</h2>
